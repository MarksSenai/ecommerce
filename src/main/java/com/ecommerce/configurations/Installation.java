...
public class Installation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Category cat6 = new Category(null, "Limpeza");
        Category cat7 = new Category(null, "Eletrodomesticos");
        Category cat8 = new Category(null, "Calçados");
        Category cat9 = new Category(null, "Mat. Eletricos");
        Category cat10 = new Category(null, "Iluminação");
